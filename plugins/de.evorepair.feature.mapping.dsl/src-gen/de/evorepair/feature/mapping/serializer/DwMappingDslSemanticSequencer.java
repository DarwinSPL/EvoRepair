 ...
 */
package de.evorepair.feature.mapping.serializer;
...
import eu.hyvar.feature.mapping.MappingPackage;
...
public class DwMappingDslSemanticSequencer extends EvoExpressionDslSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == HyDataValuesPackage.eINSTANCE)
		...
		else if (epackage == DEcorePackage.eINSTANCE)
			switch (semanticObject.eClass().getClassifierID()) {
			case DEcorePackage.DE_DELTA_INVOKATION:
				sequence_DEDeltaInvokation(context, (DEDeltaInvokation) semanticObject); 
				return; 
			}
			...
			switch (semanticObject.eClass().getClassifierID()) {
			case MappingPackage.HY_MAPPING:
				sequence_HyMapping(context, (HyMapping) semanticObject); 
				return; 
			case MappingPackage.HY_MAPPING_MODEL:
				sequence_HyMappingModel(context, (HyMappingModel) semanticObject); 
				return; 
			}
	...
	/**
	 * Contexts:
	 *     DEDeltaInvokation returns DEDeltaInvokation
	 *
	 * Constraint:
	 *     delta=[DEDelta|ID]
	 */
	protected void sequence_DEDeltaInvokation(ISerializationContext context, DEDeltaInvokation semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, DEcorePackage.Literals.DE_DELTA_INVOKATION__DELTA) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DEcorePackage.Literals.DE_DELTA_INVOKATION__DELTA));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getDEDeltaInvokationAccess().getDeltaDEDeltaIDTerminalRuleCall_1_0_1(), semanticObject.eGet(DEcorePackage.Literals.DE_DELTA_INVOKATION__DELTA, false));
		feeder.finish();
	}
	...
	/**
	 * Contexts:
	 *     HyMappingModel returns HyMappingModel
	 *
	 * Constraint:
	 *     (mappings+=HyMapping mappings+=HyMapping?)
	 */
	protected void sequence_HyMappingModel(ISerializationContext context, HyMappingModel semanticObject) {
	...
	/**
	 * Contexts:
	 *     HyMapping returns HyMapping
	 *
	 * Constraint:
	 *     (expression=EvoMappingExpression deltaInvokations+=DEDeltaInvokation ((validSince=DATE validUntil=DATE) | validSince=DATE | validUntil=DATE)?)
	 */
	protected void sequence_HyMapping(ISerializationContext context, HyMapping semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
