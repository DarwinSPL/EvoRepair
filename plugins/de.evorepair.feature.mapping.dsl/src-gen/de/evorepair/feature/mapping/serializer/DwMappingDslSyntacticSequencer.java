...
public class DwMappingDslSyntacticSequencer extends AbstractSyntacticSequencer {

	protected DwMappingDslGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (DwMappingDslGrammarAccess) access;
	 ...
	 *     (rule start) (ambiguity) {HyAndExpression.operand1=}
