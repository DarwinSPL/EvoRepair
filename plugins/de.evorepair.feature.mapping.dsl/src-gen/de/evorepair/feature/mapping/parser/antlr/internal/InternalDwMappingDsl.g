...
entryRuleHyMappingModel returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getHyMappingModelRule()); }
	iv_ruleHyMappingModel=ruleHyMappingModel
	{ $current=$iv_ruleHyMappingModel.current; }
	EOF;

// Rule HyMappingModel
ruleHyMappingModel returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleDEDeltaInvokation returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getDEDeltaInvokationRule()); }
	iv_ruleDEDeltaInvokation=ruleDEDeltaInvokation
	{ $current=$iv_ruleDEDeltaInvokation.current; }
	EOF;

// Rule DEDeltaInvokation
ruleDEDeltaInvokation returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleHyMapping returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getHyMappingRule()); }
	iv_ruleHyMapping=ruleHyMapping
	{ $current=$iv_ruleHyMapping.current; }
	EOF;

// Rule HyMapping
ruleHyMapping returns [EObject current=null]
@init {
	enterRule();
}
@after {
