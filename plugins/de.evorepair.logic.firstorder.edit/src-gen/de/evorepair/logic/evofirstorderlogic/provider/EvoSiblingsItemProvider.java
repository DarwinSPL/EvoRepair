...
/**
 * This is the item provider adapter for a {@link de.evorepair.logic.evofirstorderlogic.EvoSiblings} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EvoSiblingsItemProvider extends EvoPredefinedVariableItemProvider
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EvoSiblings_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EvoSiblings_type_feature", "_UI_EvoSiblings_type"),
				 EvoFirstOrderLogicPackage.Literals.EVO_SIBLINGS__TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object)
	{
		...
		return label == null || label.length() == 0 ?
			...
			getString("_UI_EvoSiblings_type") + " " + label;
	}
