 ...
 * </p>
 * <ul>
 *   <li>{@link de.evorepair.logic.evoLogicLanguage.EvoAnd#getLeftElement <em>Left Element</em>}</li>
 *   <li>{@link de.evorepair.logic.evoLogicLanguage.EvoAnd#getRightElement <em>Right Element</em>}</li>
 * </ul>
 *
 * @see de.evorepair.logic.evoLogicLanguage.EvoLogicLanguagePackage#getEvoAnd()
 * @model
 * @generated
 */
public interface EvoAnd extends EvoAbstractTerm
{
  /**
   ...
   * @see de.evorepair.logic.evoLogicLanguage.EvoLogicLanguagePackage#getEvoAnd_LeftElement()
  ...
  /**
   * Sets the value of the '{@link de.evorepair.logic.evoLogicLanguage.EvoAnd#getLeftElement <em>Left Element</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.evorepair.logic.evoLogicLanguage.EvoLogicLanguagePackage#getEvoAnd_RightElement()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.evorepair.logic.evoLogicLanguage.EvoAnd#getRightElement <em>Right Element</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
