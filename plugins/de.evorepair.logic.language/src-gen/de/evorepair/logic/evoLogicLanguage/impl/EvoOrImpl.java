 ...
 * </p>
 * <ul>
 *   <li>{@link de.evorepair.logic.evoLogicLanguage.impl.EvoOrImpl#getLeftElement <em>Left Element</em>}</li>
 *   <li>{@link de.evorepair.logic.evoLogicLanguage.impl.EvoOrImpl#getRightElement <em>Right Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EvoOrImpl extends EvoAbstractTermImpl implements EvoOr
{
  ...
  {
    return EvoLogicLanguagePackage.Literals.EVO_OR;
  }
  ...
  public NotificationChain basicSetLeftElement(EvoAbstractTerm newLeftElement, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EvoLogicLanguagePackage.EVO_OR__LEFT_ELEMENT, oldLeftElement, newLeftElement);
  ...
  public void setLeftElement(EvoAbstractTerm newLeftElement)
  {
    if (newLeftElement != leftElement)
    {
      ...
      if (leftElement != null)
        msgs = ((InternalEObject)leftElement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EvoLogicLanguagePackage.EVO_OR__LEFT_ELEMENT, null, msgs);
      if (newLeftElement != null)
        msgs = ((InternalEObject)newLeftElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EvoLogicLanguagePackage.EVO_OR__LEFT_ELEMENT, null, msgs);
      msgs = basicSetLeftElement(newLeftElement, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EvoLogicLanguagePackage.EVO_OR__LEFT_ELEMENT, newLeftElement, newLeftElement));
  }
  ...
  public NotificationChain basicSetRightElement(EvoAbstractTerm newRightElement, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EvoLogicLanguagePackage.EVO_OR__RIGHT_ELEMENT, oldRightElement, newRightElement);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setRightElement(EvoAbstractTerm newRightElement)
  {
    if (newRightElement != rightElement)
    {
      ...
      if (rightElement != null)
        msgs = ((InternalEObject)rightElement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EvoLogicLanguagePackage.EVO_OR__RIGHT_ELEMENT, null, msgs);
      if (newRightElement != null)
        msgs = ((InternalEObject)newRightElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EvoLogicLanguagePackage.EVO_OR__RIGHT_ELEMENT, null, msgs);
      msgs = basicSetRightElement(newRightElement, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EvoLogicLanguagePackage.EVO_OR__RIGHT_ELEMENT, newRightElement, newRightElement));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EvoLogicLanguagePackage.EVO_OR__LEFT_ELEMENT:
        return basicSetLeftElement(null, msgs);
      case EvoLogicLanguagePackage.EVO_OR__RIGHT_ELEMENT:
