 ...
 * </p>
 * <ul>
 *   <li>{@link de.evorepair.logic.evoLogicLanguage.EvoXOr#getLeftElement <em>Left Element</em>}</li>
 *   <li>{@link de.evorepair.logic.evoLogicLanguage.EvoXOr#getRightElement <em>Right Element</em>}</li>
 * </ul>
 *
 * @see de.evorepair.logic.evoLogicLanguage.EvoLogicLanguagePackage#getEvoXOr()
 * @model
 * @generated
 */
public interface EvoXOr extends EvoAbstractTerm
{
  /**
   ...
   * @see de.evorepair.logic.evoLogicLanguage.EvoLogicLanguagePackage#getEvoXOr_LeftElement()
  ...
  /**
   * Sets the value of the '{@link de.evorepair.logic.evoLogicLanguage.EvoXOr#getLeftElement <em>Left Element</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.evorepair.logic.evoLogicLanguage.EvoLogicLanguagePackage#getEvoXOr_RightElement()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.evorepair.logic.evoLogicLanguage.EvoXOr#getRightElement <em>Right Element</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
