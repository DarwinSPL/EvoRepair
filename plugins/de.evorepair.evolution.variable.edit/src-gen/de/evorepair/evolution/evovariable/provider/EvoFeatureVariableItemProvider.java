...
/**
 * This is the item provider adapter for a {@link de.evorepair.evolution.evovariable.EvoFeatureVariable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EvoFeatureVariableItemProvider extends EvoVariableItemProvider
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EvoFeatureVariable_feature_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EvoFeatureVariable_feature_feature", "_UI_EvoFeatureVariable_type"),
				 EvoVariablePackage.Literals.EVO_FEATURE_VARIABLE__FEATURE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns EvoFeatureVariable.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object)
	{
		...
		return label == null || label.length() == 0 ?
			...
			getString("_UI_EvoFeatureVariable_type") + " " + label;
	}
