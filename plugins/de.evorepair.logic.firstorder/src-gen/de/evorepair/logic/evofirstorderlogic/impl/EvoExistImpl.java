 ...
 * @generated
 */
public class EvoExistImpl extends EvoAbstractTermImpl implements EvoExist
{
	/**
	...
	{
		return EvoFirstOrderLogicPackage.Literals.EVO_EXIST;
	}
	...
	public NotificationChain basicSetElement(EvoAbstractTerm newElement, NotificationChain msgs)
	{
		...
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EvoFirstOrderLogicPackage.EVO_EXIST__ELEMENT, oldElement, newElement);
	...
	public void setElement(EvoAbstractTerm newElement)
	{
		if (newElement != element)
		{
			...
			if (element != null)
				msgs = ((InternalEObject)element).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EvoFirstOrderLogicPackage.EVO_EXIST__ELEMENT, null, msgs);
			if (newElement != null)
				msgs = ((InternalEObject)newElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EvoFirstOrderLogicPackage.EVO_EXIST__ELEMENT, null, msgs);
			msgs = basicSetElement(newElement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EvoFirstOrderLogicPackage.EVO_EXIST__ELEMENT, newElement, newElement));
	}
	...
	public EList<EvoVariable> getBoundedVariables()
	{
		...
		{
			boundedVariables = new EObjectContainmentEList<EvoVariable>(EvoVariable.class, this, EvoFirstOrderLogicPackage.EVO_EXIST__BOUNDED_VARIABLES);
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
	{
		if (baseClass == EvoAbstractOneParameterTerm.class)
		{
			...
			{
				case EvoFirstOrderLogicPackage.EVO_EXIST__ELEMENT: return EvoFirstOrderLogicPackage.EVO_ABSTRACT_ONE_PARAMETER_TERM__ELEMENT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
	{
		if (baseClass == EvoAbstractOneParameterTerm.class)
		{
			...
			{
				case EvoFirstOrderLogicPackage.EVO_ABSTRACT_ONE_PARAMETER_TERM__ELEMENT: return EvoFirstOrderLogicPackage.EVO_EXIST__ELEMENT;
				default: return -1;
			}
		}
