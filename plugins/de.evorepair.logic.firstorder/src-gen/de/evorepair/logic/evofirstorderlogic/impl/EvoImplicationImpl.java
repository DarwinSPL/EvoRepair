 ...
 * </p>
 * <ul>
 *   <li>{@link de.evorepair.logic.evofirstorderlogic.impl.EvoImplicationImpl#getLeftElement <em>Left Element</em>}</li>
 *   <li>{@link de.evorepair.logic.evofirstorderlogic.impl.EvoImplicationImpl#getRightElement <em>Right Element</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public void setLeftElement(EvoAbstractTerm newLeftElement)
	{
		if (newLeftElement != leftElement)
		{
			...
			if (newLeftElement != null)
				msgs = ((InternalEObject)newLeftElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EvoFirstOrderLogicPackage.EVO_IMPLICATION__LEFT_ELEMENT, null, msgs);
			msgs = basicSetLeftElement(newLeftElement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EvoFirstOrderLogicPackage.EVO_IMPLICATION__LEFT_ELEMENT, newLeftElement, newLeftElement));
	}
	...
	public void setRightElement(EvoAbstractTerm newRightElement)
	{
		if (newRightElement != rightElement)
		{
			...
			if (newRightElement != null)
				msgs = ((InternalEObject)newRightElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EvoFirstOrderLogicPackage.EVO_IMPLICATION__RIGHT_ELEMENT, null, msgs);
			msgs = basicSetRightElement(newRightElement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EvoFirstOrderLogicPackage.EVO_IMPLICATION__RIGHT_ELEMENT, newRightElement, newRightElement));
	}
