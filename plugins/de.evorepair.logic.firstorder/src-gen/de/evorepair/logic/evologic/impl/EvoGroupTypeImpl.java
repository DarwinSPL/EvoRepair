 ...
 * </p>
 * <ul>
 *   <li>{@link de.evorepair.logic.evologic.impl.EvoGroupTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.evorepair.logic.evologic.impl.EvoGroupTypeImpl#getVariables <em>Variables</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EvoGroupTypeImpl extends HyExpressionImpl implements EvoGroupType
{
	...
	public void setType(HyGroupTypeEnum newType)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EvoLogicPackage.EVO_GROUP_TYPE__TYPE, oldType, type));
	}
