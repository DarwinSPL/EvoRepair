 ...
 * </p>
 * <ul>
 *   <li>{@link de.evorepair.logic.evologic.impl.EvoFormulaImpl#getTerm <em>Term</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EvoFormulaImpl extends MinimalEObjectImpl.Container implements EvoFormula
{
	...
	public void setTerm(HyExpression newTerm)
	{
		if (newTerm != term)
		{
			...
			if (newTerm != null)
				msgs = ((InternalEObject)newTerm).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EvoLogicPackage.EVO_FORMULA__TERM, null, msgs);
			msgs = basicSetTerm(newTerm, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EvoLogicPackage.EVO_FORMULA__TERM, newTerm, newTerm));
	}
