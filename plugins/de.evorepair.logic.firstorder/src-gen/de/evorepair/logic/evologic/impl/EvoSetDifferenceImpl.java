 ...
 * </p>
 * <ul>
 *   <li>{@link de.evorepair.logic.evologic.impl.EvoSetDifferenceImpl#getOperand1 <em>Operand1</em>}</li>
 *   <li>{@link de.evorepair.logic.evologic.impl.EvoSetDifferenceImpl#getOperand2 <em>Operand2</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EvoSetDifferenceImpl extends EvoAbstractSetTermImpl implements EvoSetDifference {
	...
	public void setOperand1(HyExpression newOperand1) {
		if (newOperand1 != operand1) {
			...
			if (newOperand1 != null)
				msgs = ((InternalEObject)newOperand1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EvoLogicPackage.EVO_SET_DIFFERENCE__OPERAND1, null, msgs);
			msgs = basicSetOperand1(newOperand1, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EvoLogicPackage.EVO_SET_DIFFERENCE__OPERAND1, newOperand1, newOperand1));
	}
	...
	public void setOperand2(HyExpression newOperand2) {
		if (newOperand2 != operand2) {
			...
			if (newOperand2 != null)
				msgs = ((InternalEObject)newOperand2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EvoLogicPackage.EVO_SET_DIFFERENCE__OPERAND2, null, msgs);
			msgs = basicSetOperand2(newOperand2, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EvoLogicPackage.EVO_SET_DIFFERENCE__OPERAND2, newOperand2, newOperand2));
	}
