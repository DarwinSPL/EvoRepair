...
entryRuleMappingRepairGrammarEntry returns [EObject current=null]:
	...
	{ $current=$iv_ruleMappingRepairGrammarEntry.current; }
	EOF;

// Rule MappingRepairGrammarEntry
ruleMappingRepairGrammarEntry returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleEvoMappingRepairExpression returns [EObject current=null]:
	...
	{ $current=$iv_ruleEvoMappingRepairExpression.current; }
	EOF;

// Rule EvoMappingRepairExpression
ruleEvoMappingRepairExpression returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_EvoMappingKeep_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_EvoMappingReplace_1.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleEvoMappingKeep returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getEvoMappingKeepRule()); }
	iv_ruleEvoMappingKeep=ruleEvoMappingKeep
	{ $current=$iv_ruleEvoMappingKeep.current; }
	EOF;

// Rule EvoMappingKeep
ruleEvoMappingKeep returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleEvoMappingReplace returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getEvoMappingReplaceRule()); }
	iv_ruleEvoMappingReplace=ruleEvoMappingReplace
	{ $current=$iv_ruleEvoMappingReplace.current; }
	EOF;

// Rule EvoMappingReplace
ruleEvoMappingReplace returns [EObject current=null]
@init {
	enterRule();
}
@after {
